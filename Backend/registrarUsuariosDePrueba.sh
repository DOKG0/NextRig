...
curl -X POST $apiEndpoint -H "Content-Type: application/json" -d '{"ci": "99999999","nombre": "John","apellido": "Rambo","username": "john","correo": "john@mail.com","password": "1234","fechaNac": "2000-04-26"}'